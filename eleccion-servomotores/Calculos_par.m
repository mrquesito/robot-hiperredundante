...
%También nos vale, pero más justito
masas(6) = masas(7);
...
%Se pasa. Hay que ir a otro motor. El AX-18A (1.8Nm)
masas(5) = 0.0559;
%A ver si ahora...
m56 = masas(5)+masas(6);
tau5 = S*g*(m56*r+m78*5*r+m910*9*r+mHerr*11*r)
...
%Motor 4
%Probamos con el AX-18A
tau4 = C*g*(m56*3*r+m78*7*r+m910*11*r+mHerr*13*r)
%No llega. Ponemos el siguiente. MX-28T (2.5Nm)
masas(4) = 0.072;
...
%Muy justo, pero lo da. Aceptamos.

%Motor 2
%Calculamos el par
tau2 = C*g*(m34*3*r+m56*7*r+m78*11*r+m910*15*r+mHerr*17*r)
%Elegimos el XM430-W210-T (4.1Nm)
masas(2) = 0.082;
